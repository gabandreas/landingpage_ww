...
import { Building2, Tv, TrendingUp, ShieldCheck, ArrowRight, Mail, Briefcase, Megaphone, CheckCircle2 } from 'lucide-react';
      ...
      items: [
        {
          ...
          desc: "Upgrade your guest experience. We provide Set-Top Boxes (STB) pre-loaded with WeWatch premium access. Replace boring local TV with the Asian content your guests love.",
        ...
        },
        {
          ...
          desc: "Connect your brand with a growing, tech-savvy audience. Our platform offers high-visibility placements without disrupting the user experience.",
      ...
      items: [
        {
          ...
          desc: "Tingkatkan pengalaman tamu Anda. Kami menyediakan Set-Top Box (STB) siap pakai dengan akses premium WeWatch. Ganti saluran TV biasa dengan konten Asia yang diminati tamu.",
          icon: <Building2 className="w-8 h-8 text-white" />,
        ...
        },
        {
          ...
          desc: "Hubungkan brand Anda dengan komunitas yang terus tumbuh. Platform kami menawarkan penempatan iklan strategis dengan visibilitas tinggi.",
          icon: <Megaphone className="w-8 h-8 text-white" />,
...
export default function BusinessPage() {
  ...
  return (
    <main className="min-h-screen bg-[#040714] relative overflow-hidden text-white">
      
      {/* --- BACKGROUND ELEMENTS (Sama seperti Subscription Page) --- */}
      {/* Grid Pattern */}
      ...
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-20 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 mb-24">
          ...
          {/* Right: Value Props (Grid yang Rapih & Seragam) */}
          <motion.div 
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            {t.values.map((val, i) => (
              <div key={i} className="bg-[#0E1425]/80 backdrop-blur-sm border border-white/5 p-6 rounded-2xl flex flex-col items-start hover:border-blue-500/30 transition-all duration-300 group">
        ...
        {/* --- SOLUTIONS SECTION (Clean & Corporate Look) --- */}
        <div className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {t.solutions.items.map((item, i) => (
              <motion.div 
                ...
                className="group relative rounded-2xl overflow-hidden border border-white/10 bg-[#0a0f1c] flex flex-col hover:border-blue-500/30 transition-all duration-300"
              >
                {/* Header Gradient Minimalis (Dark Blue) */}
                <div className="h-32 w-full flex items-center justify-center bg-gradient-to-b from-[#0E1425] to-[#0a0f1c] border-b border-white/5 relative">
                   {/* Background accent pattern */}
                   <div className="absolute inset-0 bg-[url('/images/grid.svg')] opacity-5"></div>
                   
                   <div className="p-4 rounded-full bg-white/5 border border-white/10 group-hover:scale-110 transition-transform duration-500 z-10">
                      {item.icon}
                   </div>
                </div>
