    ...
    <footer className="w-full bg-[#040714] border-t border-white/10 pt-12 sm:pt-16 pb-8 text-sm font-sans">
      <div className="mx-auto w-full max-w-7xl px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-10 sm:gap-10 mb-12">
          ...
          {/* Column 3: Corporate */}
          <div className="flex flex-col gap-3 sm:gap-4">
            <h4 className="text-white font-semibold text-base">{t.corporate}</h4>
            <ul className="space-y-2 sm:space-y-3 text-gray-400">
              <li>
                <a href="https://www.wewatch.asia/" target="_blank" className="hover:text-blue-400 transition-colors text-xs sm:text-sm flex items-center gap-1">
                  {t.menu.about_corp} <ExternalLink className="w-3 h-3 opacity-50" /> 
                </a>
              </li>
              <li>
                <a href="https://www.wewatch.asia/news-center.html" target="_blank" className="hover:text-blue-400 transition-colors text-xs sm:text-sm flex items-center gap-1">
          ...
          <div className="flex flex-col gap-3 sm:gap-4">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.youtube.com/@WeWatchAsia" className="text-white hover:text-red-600 transition-colors">
        ...
        <div className="flex flex-col-reverse items-center justify-between gap-8 lg:flex-row">
          ...
          <div className="flex flex-wrap justify-center lg:justify-end gap-3">
             ...
             <StoreButton href="https://appgallery.huawei.com/app/C104739437" subText={t.store.explore} mainText="AppGallery" iconPath={<svg className="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24"><path fill="#C7000B" d="M7.4 2h9.2c3.2 0 5.4 2.2 5.4 5.4v9.2c0 3.2-2.2 5.4-5.4 5.4H7.4C4.2 22 2 19.8 2 16.6V7.4C2 4.2 4.2 2 7.4 2z"/><path fill="#FFF" d="M16.5 13.5c0 .6-.3 1.1-.7 1.5-.4.4-1 .6-1.5.7-.6 0-1.2-.2-1.6-.5l-4.8-3.2c-.7-.5-1.1-1.2-1.1-2 0-.8.4-1.5 1.1-2l4.8-3.2c.4-.3 1-.5 1.6-.5.6 0 1.1.2 1.5.7.4.4.7.9.7 1.5v7z" opacity=".9"/><path fill="#FFF" d="M15.3 13.8c-.3.3-.7.5-1.1.5-.4 0-.8-.1-1.1-.3l-3.6-2.4c-.5-.3-.8-.9-.8-1.5 0-.6.3-1.1.8-1.5l3.6-2.4c.3-.2.7-.3 1.1-.3.4 0 .8.2 1.1.5.3.3.5.7.5 1.2v4.8c0 .5-.2.9-.5 1.2z"/></svg>} />
          </div>
        </div>
...
function StoreButton({ href, subText, mainText, iconPath }: any) {
    return (
      <a href={href} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-black border border-white/20 rounded-lg px-4 py-2 hover:bg-white/5 transition-all hover:border-white/40 group min-w-[130px] sm:min-w-[140px]">
         {iconPath}
         <div className="text-left">
           <div className="text-[8px] sm:text-[9px] uppercase leading-none text-gray-400">{subText}</div>
           <div className="text-[11px] sm:text-xs font-semibold text-white">{mainText}</div>
         </div>
      </a>
    )
}